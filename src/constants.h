...
#define Q 0.01                                   // Carica particelle
#define TIME_IN 0                                // Tempo inizio simulazione
#define TIME_END 100                             // Tempo fine simulazione
#define DELTA_T 1e-3                             // INtervallo temporale
#define N_STEPS ((TIME_END - TIME_IN) / DELTA_T) // NUmero di step